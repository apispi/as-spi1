...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/api/collections/{id}/run-dataset', [CollectionController::class, 'runDataset'])
        ->middleware('throttle:outbound-test');
    Route::get('/api/collections/{id}/export', [CollectionController::class, 'export']);
    Route::get('/api/collections/{id}/export/openapi', [CollectionController::class, 'exportOpenApi']);
    ...
    Route::post('/api/explore', [\App\Http\Controllers\ExploreController::class, 'explore'])->middleware('throttle:outbound-test');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::post('/api/admin/users/{id}/revoke-sessions', [AdminController::class, 'revokeSessions']);
    Route::post('/api/admin/users/{id}/disable-2fa', [AdminController::class, 'disableTwoFactor']);
